...
<body>
    ...
    <h2>Cadastro Civil</h2>
        <form name= "formulario" action="cad_pessoa.php" method=POST>
            ...
            <a href="\sys_protocol\form_pessoa.php" class="btn btn-secondary" tabindex="-1" role="button" aria-disabled="true">Limpar</a>
